      ...
      <div className="nav-dropdown-items">
        <div className="nav-dropdown-userinfo">
          ...
          <div className="money-info">
            <div className="nav-dropdown-portfolio-value-div">
              ...
              <p className="nav-dropdown-buying-power-text">Portfolio Value</p>
            </div>
            <div className="nav-dropdown-buying-power-div">
              <p className="nav-dropdown-buying-power">
                {this.convert_to_decimal(buying_power)}
              </p>
              <p className="nav-dropdown-buying-power-text">Buying Power</p>
            </div>
          </div>
        </div>
        ...
        <div className="nav-dropdown-logout">
          <button className="logout-button" onClick={this.props.logout}>
            ...
            <span className="logout-button-span">Log Out</span>
          </button>
        </div>
      </div>
    );
